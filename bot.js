...
client.on('message', message => { 
    ...
    .setFooter(`${message.author.username}$#{message.author.discrim}`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
...
client.on('guildCreate', guild => {
  client.channels.get("471738698111647763").send(`**تم ادخال البوت في سيرفر اخر
...
client.on('guildDelete', guild => {
  client.channels.get("471738698111647763").send(`**تم اخراج البوت من احد السيرفرات
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`)
